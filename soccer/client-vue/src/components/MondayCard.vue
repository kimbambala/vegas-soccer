<template>
    <div class="monday-card">
        <h1 class="main-text">Playing On Mondays</h1>
                    ...
                    <div class="group-card-grid">
                        <div class="group-card">
                            ...
                            <div class="card-image">
                                <img src="../assets/images/carlos-felipe-ramirez-mesa-UlTugm5H1JI-unsplash.jpg" alt="">
                            </div>
  ...
  export default {
    ...
    created(){
        GroupService.getMondayGroups().then((response)=>{
